            ...
            return resp(
                ...
                headers,
                {
                    ...
                    "user": {
                        ...
                        "chat_status": user.get("chat_status", False),
                        "chatfact_status" : user.get("chatfact_status", False),
                        "breakdown_status" : user.get("breakdown_status", False),
                        "generation_status" : user.get("generation_status", False),
                        "generation_completed_status" : user.get("generation_completed_status", False),
                        "submit_for_review_status" : user.get("submit_for_review_status", False),
                        "connector_status" : user.get("connector_status", False),
                        "add_profile_status" : user.get("add_profile_status", False),
                        "campaign_start_status" : user.get("campaign_start_status", False),
                        "campaign_goal_status" : user.get("campaign_goal_status", False),
                        "campaign_recommend_status" : user.get("campaign_recommend_status", False),
                        "campaign_posts_status" : user.get("campaign_posts_status", False),
                        "posts_history_status" : user.get("posts_history_status", False),
                        "campaign_dashboard_status" : user.get("campaign_dashboard_status", False),
                        "quick_posts_status" : user.get("quick_posts_status", False),
                        "cammi_assistant_status" : user.get("cammi_assistant_status", False),
                        "image_generation_status" : user.get("image_generation_status", False),
                    },
                },
            )
