...
CORS_HEADERS = {
    ...
    "Access-Control-Allow-Headers": "Content-Type, project_id, document_type"
}
...
def lambda_handler(event, context):
    ...
    # Query DynamoDB for this project_id
    try:
        response = project_questions_table.query(
    ...
    # Filter items to match hardcoded questions
    filtered_items = [item for item in items if item.get('question_text') in question_list]
